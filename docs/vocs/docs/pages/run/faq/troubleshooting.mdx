...
2. Have slow canonical commit time according to the `Canonical Commit Latency Time` chart on [Grafana dashboard](/vocs/docs/pages/run/monitoring.mdx#observability-with-prometheus-grafana) (more than 2-3 seconds)
